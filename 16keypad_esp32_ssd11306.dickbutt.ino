...
const byte Output[rows]={15,16,18,19}; //array of pins used as output for rows of keypad
const byte Input[columns]={2,0,4,5}; //array of pins used as input for columnss of keypad
